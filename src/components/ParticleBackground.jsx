...
export default function ParticleBackground() {
  ...
  useEffect(() => {
    ...
    const rings     = Array.from({ length: RING_COUNT }, () => new Ring());
    ...
    const animate = () => {
      ...
      // Orbs (layer underneath everything)
      ...
      // Meteors (spawn every ~180 frames)
      meteorTimer++;
